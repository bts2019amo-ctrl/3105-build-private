...
enum GamePatchVersion: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .skin: return "FREE FIRE SKIN"
        }
    }
    ...
    var assetName: String {
        ...
        case .skin: return "free_fire_normal"
        }
    }
...
private struct GameVersionCard: View {
    ...
    var body: some View {
        ...
        .overlay { RoundedRectangle(cornerRadius: 30, style: .continuous).stroke(version.accent.opacity(0.55), lineWidth: 1) }
